...
describe("GenreList", () => {
  ...
  describe("ARIA group semantics (UX-02)", () => {
    it("GenreRow tr has aria-labelledby", () => {
      ...
      const tr = container.querySelector('tr[aria-labelledby="genre-row-g1"]');
    ...
    it("GenreRow name Link has id attribute", () => {
      ...
      const linkWithId = links.find((l) => l.getAttribute("id") === "genre-row-g1");
    ...
    it("GenreCard outer div has role='group' and aria-labelledby", () => {
      ...
      const g2Group = groups.find((g) => g.getAttribute("aria-labelledby") === "genre-card-g2");

...
1. **Base UI patterns** — Button+Link pattern, semantic tokens, no nested forms: `base-ui-patterns.md`
2. **Server/Client split** — when `"use client"` is genuinely needed: `server-client-split.md`

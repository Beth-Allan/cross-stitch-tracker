...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/wanderskye/Projects/cross-stitch-tracker/.claude
                  → checks /Users/wanderskye/Projects/cross-stitch-tracker/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done
                  → writes to /Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/hooks/
...
@/Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

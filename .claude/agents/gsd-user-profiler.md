...
<reference>
@/Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/wanderskye/Projects/cross-stitch-tracker/.claude/get-shit-done/references/user-profiling.md` to load:

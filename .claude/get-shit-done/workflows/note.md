...
- **Global scope**: `/Users/wanderskye/Projects/cross-stitch-tracker/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/wanderskye/Projects/cross-stitch-tracker/.claude/notes/`)
...
2. Glob `/Users/wanderskye/Projects/cross-stitch-tracker/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/wanderskye/Projects/cross-stitch-tracker/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/wanderskye/Projects/cross-stitch-tracker/.claude/notes/` — works in any directory

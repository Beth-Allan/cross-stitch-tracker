...
- **SECTION_NAME** = [Human-readable name, e.g., "Project Management" or "Goals & Plans"]
- **SECTION_ID** = [Folder name in sections/, e.g., "project-management" or "goals-and-plans"]
- **NN** = [Milestone number, e.g., "02" or "08" — sections start at 02 since 01 is Shell]
...
Please carefully read and analyse the following files:
...
- **@product-plan/sections/SECTION_ID/tests.md** — UI behaviour test specs

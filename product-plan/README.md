# Cross Stitch Tracker — Design Handoff

This folder contains everything needed to implement Cross Stitch Tracker.
...
- `instructions/incremental/` — 8 milestone instructions (shell, then 7 sections)

**Design Assets:**
- `design-system/` — Colours, fonts, design tokens
- `data-shapes/` — UI data contracts (the shapes of data components expect)
- `shell/` — Application shell components
- `sections/` — 7 section component packages with test specs
...
| # | Section | Milestone | Key Components |
|---|---------|-----------|----------------|
| 1 | Shell | 01-shell.md | AppShell, MainNav, UserMenu |
| 2 | Project Management | 02-project-management.md | ChartGallery, ChartDetail, ChartAddForm, ChartEditModal |
| 3 | Supply Tracking | 03-supply-tracking-and-shopping.md | SupplyCatalog, SupplyDetailModal, ProjectSuppliesTab, BulkSupplyEditor |
| 4 | Stitching Stats | 04-stitching-sessions-and-statistics.md | StitchingDashboard (4 tabs), ProjectSessionsTab, LogSessionModal, YearInReview |
| 5 | Reference Data | 05-fabric-series-and-reference-data.md | FabricCatalog, Designer, Series, Storage |
| 6 | Gallery & Filters | 06-gallery-cards-and-advanced-filtering.md | GalleryView (3 modes), GalleryCard, AdvancedFilterBar |
| 7 | Dashboards | 07-dashboards-and-views.md | MainDashboard, PatternDive, ProjectDashboard, ShoppingCart |
| 8 | Goals & Plans | 08-goals-and-plans.md | GoalsAndPlans (4 tabs), ProjectGoalsPanel |

## Testing

Each section includes a `tests.md` file with UI behaviour test specs. For best results:
...
The test specs are **framework-agnostic** — they describe WHAT to test (user-facing behaviour), not HOW. Adapt to your testing setup.
...
- **Must scale to 500+ projects** — All designs use pagination (10 items, "Show more"), collapse-by-default, and search. Maintain these patterns.

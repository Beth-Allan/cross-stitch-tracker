...
- **Tokens:** `~/projects/cross-stitch-tracker-design/product-plan/design-system/tokens.css`
- **Typography:** `~/projects/cross-stitch-tracker-design/product-plan/design-system/fonts.md`
- **Colors:** `~/projects/cross-stitch-tracker-design/product-plan/design-system/tailwind-colors.md`
- **Components (43):** `~/projects/cross-stitch-tracker-design/product-plan/`

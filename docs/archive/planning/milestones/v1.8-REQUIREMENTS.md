# Requirements Archive: v1.8 Series & Collections
...
- [x] **SERIES-01**: User can create a series with name, optional total count, and optional designer link
- [x] **SERIES-02**: User can view all series on a management page with progress indicators
- [x] **SERIES-03**: User can edit a series (name, total count, designer link)
- [x] **SERIES-04**: User can delete a series (charts become unassigned, not deleted)
...
- [x] **SERIES-10**: User can see dual progress for each series — owned count vs total, and finished count vs owned

### Fixes

- [x] **FIX-01**: Fix pre-existing TypeScript errors in 3 test files (999.19)
- [x] **FIX-02**: Separate stats page query groups for resilience (999.22)
...
|-------------|-------|--------|
| SERIES-01 | Phase 31 | Complete |
| SERIES-02 | Phase 32 | Complete |
| SERIES-03 | Phase 31 | Complete |
| SERIES-04 | Phase 31 | Complete |

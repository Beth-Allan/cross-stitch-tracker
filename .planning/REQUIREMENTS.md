...
- [ ] **QUAL-01**: Fix all remaining silent failure patterns (bare catches, swallowed errors) across upload-actions, charts page, log-session-modal, deleteFile, processAndStoreImage (999.50, .51, .53, .54, .55)
- [ ] **QUAL-02**: Remove JSX section markers from TSX files (~20 markers) (999.30)
- [ ] **QUAL-03**: Remove WHAT-comments and section markers from test and form files (999.56, .57, .84)

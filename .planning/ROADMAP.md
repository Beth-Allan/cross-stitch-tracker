...
Cross-stitch project management app replacing Notion. v1.8 shipped 2026-07-01 with series organization, dual progress tracking, management pages, chart form integration, and Pattern Dive Series tab. 9 milestones shipped (v1.0-v1.8), 34 phases complete.
...
<details>
<summary>✅ v1.7 Fix & Polish (Phases 27-30) -- SHIPPED 2026-05-24</summary>

- [x] Phase 27: Chart Form Fixes (2/2 plans) -- completed 2026-05-23
- [x] Phase 28: Stats Corrections (3/3 plans) -- completed 2026-05-24
- [x] Phase 29: UI Polish (3/3 plans) -- completed 2026-05-24
- [x] Phase 30: Code Quality (3/3 plans) -- completed 2026-05-24
...
<details>
<summary>✅ v1.8 Series & Collections (Phases 31-34) -- SHIPPED 2026-07-01</summary>

- [x] Phase 31: Data Foundation & Fixes (3/3 plans) -- completed 2026-05-24
- [x] Phase 32: Series Management Pages (3/3 plans) -- completed 2026-05-25
- [x] Phase 33: Chart Form Integration (2/2 plans) -- completed 2026-05-26
- [x] Phase 34: Browse & Pattern Dive Integration (3/3 plans) -- completed 2026-07-01
...
- [ ] 36-01-PLAN.md -- StrandCount literal union + SuppliesTab co-dependent props (QUAL-04, QUAL-06)
- [ ] 36-02-PLAN.md -- OptionalFocalPoint discriminated union + mapFocalPoint (QUAL-05)
- [ ] 36-03-PLAN.md -- Collection types + controlled-only simplification (QUAL-07, QUAL-08)
...
| 36. Type Safety | v1.9 | 0/3 | Planned | - |

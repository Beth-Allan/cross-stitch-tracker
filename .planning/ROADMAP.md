...
Cross-stitch project management app replacing Notion. v1.7 shipped 2026-05-24 with chart form fixes, stats corrections, UI polish, and code quality improvements. 8 milestones shipped (v1.0-v1.7), 30 phases complete.
...
- 🚧 **v1.8 Series & Collections** -- Phases 31-34 (in progress)
...
- [ ] 33-01-PLAN.md — Data plumbing: seriesId validation + chart actions + hook + InlineNameDialog props

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 33-02-PLAN.md — Form UI: series SearchableSelect + dialog wiring + page data fetching
...
(Phases 32 and 33 share only a Phase 31 dependency and could execute in either order)
...
| 33. Chart Form Integration | v1.8 | 0/2 | Not started | - |
